...
vim.keymap.set('n', '<leader>cw', [[:%s/\<<C-r><C-w>\>/<C-r><C-w>/gI<Left><Left><Left>]], { desc = 'Replace word globally' })
...
vim.keymap.set('n', '<leader>i2', '<cmd>set tabstop=2 shiftwidth=2 expandtab | retab<CR>', { desc = 'Set 2-space indent' })
